...
def mobilenetv2_T_w(T, W, feature_dim=100, img_size=64):
    model = MobileNetV2(T=T, feature_dim=feature_dim, width_mult=W, input_size=img_size)
    return model


def mobile_half(num_classes, img_size=64):
    return mobilenetv2_T_w(6, 0.5, num_classes, img_size=img_size)
