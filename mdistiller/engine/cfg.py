...
# R2KD(Robustness-Reinforced Knowledge Distillation) CFG
CFG.R2KD = CN()
CFG.R2KD.TEMPERATURE = 4.0
CFG.R2KD.LOSS = CN()
CFG.R2KD.LOSS.VALUE_WEIGHT = 2.0
CFG.R2KD.LOSS.RANK_WEIGHT = 2.0
