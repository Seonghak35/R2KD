...
def main(cfg, args):
    ...
    if args.augmentation != 'NONE':
        project_name = cfg.EXPERIMENT.PROJECT + '_' + str(args.augmentation)
    else:
        project_name = cfg.EXPERIMENT.PROJECT
    experiment_name = os.path.join(project_name, experiment_name)
    ...
    # distillation
        ...
        if cfg.DISTILLER.TYPE == "CRD":
            ...
            if args.pruning:
                distiller = distiller_dict[cfg.DISTILLER.TYPE](
                        model_student, model_teacher, cfg, args.augmentation, pruned_teacher
                        )
            else:
                distiller = distiller_dict[cfg.DISTILLER.TYPE](
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="cutmix",
        choices=["mixup", "cutmix", "cutout", "autoaug", "cutmixpick"],
    )
